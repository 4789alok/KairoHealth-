...
class WritePrescriptionForMedicine extends StatefulWidget {
  const WritePrescriptionForMedicine({super.key});

  @override
  State<WritePrescriptionForMedicine> createState() =>
      _WritePrescriptionForMedicineState();
}

class _WritePrescriptionForMedicineState
    extends State<WritePrescriptionForMedicine> {
